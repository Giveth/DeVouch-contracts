...
// contract KarmaProjectResolverUpgradable is SchemaResolver, Initializable, OwnableUpgradeable {
...
//         return (projectOwner[projectId] == address(0) && _eas.getAttestation(projectId).recipient == addr)
//             || projectOwner[projectId] == addr || addr == _owner;
//     }
